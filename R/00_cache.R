...
should_I_check_cache<-function(cache = T ){
...
#=============================================================get_cache_folder
get_cache_folder<-function(forget = F ){
...
check_users_choice_if_cache<-function(cache = F ){
...
change_cache_folder<-function(folder = null ){
    if(is.null( folder )) {
        ...
        return( get_cache_folder(forget = T ))
    }
...
cache_folder_is_valid<-function(folder = "null") {
    if( to_string( folder ) == "null" ) return (F)
